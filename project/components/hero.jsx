const Hero = ({ t, modules }) => {
  const openDemo = useOpenDemo();
  // Place 12 chips on two rings (r1=outer, r2=inner)
        ...
        <div className="hero-grid">
          <div>
            ...
            <div className="hero-ctas">
              <button className="btn btn-primary btn-lg" onClick={openDemo}>{t.hero.cta_primary} <Icon name="arrow" size={14}/></button>
              <button className="btn btn-outline btn-lg" onClick={openDemo}>{t.hero.cta_secondary}</button>
            </div>
