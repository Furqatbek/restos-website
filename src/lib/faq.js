// FAQ content shared between the client <FAQ> component (rendered UI) and
// the server-rendered homepage (FAQPage JSON-LD for Google rich results).
export const FAQS = {
  en: [
    ...
    ['Which delivery apps?', 'Uzum Tezkor, Express24, Yandex Eats, Wolt — orders land straight in your POS. No second tablet.'],
  ],
  ru: [
    ...
    ['Какие доставки?', 'Uzum Tezkor, Express24, Yandex Eats, Wolt — заказы падают прямо в вашу кассу. Без второго планшета.'],
  ],
  uz: [
    ...
    ['Qaysi yetkazuvchilar?', 'Uzum Tezkor, Express24, Yandex Eats, Wolt — buyurtmalar to‘g‘ridan-to‘g‘ri kassangizga tushadi. Ikkinchi planshetsiz.'],
  ],
  'uz-cyr': [
    ...
    ['Қайси етказувчилар?', 'Uzum Tezkor, Express24, Yandex Eats, Wolt — буюртмалар тўғридан-тўғри кассангизга тушади. Иккинчи планшетсиз.'],
  ],
  kaa: [
    ...
    ['Qaysı jetkeriwshiler?', 'Uzum Tezkor, Express24, Yandex Eats, Wolt — buyırtpalar tuwrıdan-tuwrı kassańızǵa túsedi. Ekinshi planshetsiz.'],
  ],
};
